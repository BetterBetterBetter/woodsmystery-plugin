...
1. Plugin header: `Version: 0.1.0`
2. Constant: `define( 'WMP_SITE_PLUGIN_VERSION', '0.1.0' );`
...
zip -r woodsmystery-plugin-0.1.0.zip woodsmystery-plugin \
...
2. Create a tag named `v0.1.0`.
3. Release title: `Version 0.1.0`.
4. Add release notes.
5. Upload `woodsmystery-plugin-0.1.0.zip` as a release asset.
6. Publish the release.

Option B: GitHub CLI

```bash
gh release create v0.1.0 woodsmystery-plugin-0.1.0.zip \
